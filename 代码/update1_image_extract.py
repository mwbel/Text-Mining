...
if __name__ == "__main__":
    file_path="/Users/Pro/Documents/Others/应用项目/Text Mining/待处理/201808/未处理的报告/按券商分类/方正"
    # file_path="D:/test"
    out_path="/Users/Pro/Documents/Others/应用项目/Text Mining/待处理/201808/未处理的报告/按券商分类/方正/output_pic/"
...
# if __name__ == "__main__":
#     file_path="E:/项目/Demo/试运行/201808/基业常青经济研究院"
#     # file_path="D:/test"
#     out_path="E:/pic/1/基业常青经济研究院/"
#     pdf_files = [name for name in os.listdir(file_path) if name.endswith('.pdf')]
#     for pdf in pdf_files:
#         out_path="E:/pic/1/基业常青经济研究院/"
#         pdf_path=os.path.join(file_path,pdf)
#         ##TODO根据名字确定券商
#         broker_arg=get_brokerarg('基业常青经济研究院')
#         out_path=os.path.join(out_path,os.path.splitext(os.path.basename(pdf_path))[0])
#         if not os.path.exists(out_path):
#             os.makedirs(out_path)
#         shutil.copy(pdf_path,out_path)
