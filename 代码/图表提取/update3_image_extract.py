...
input_path = r'D:/测试文件'
broker_name = r'D:/update_code/券商名称'
store_path = "D:/pic1/已处理完成"
failure_path = "D:/pic1/failure_path"
            ...
            try:
                ...
                if broker_arg:
                    ...
                    if pagenum<10:
                        ...
                        if not os.path.exists(os.path.join(failure_path_page,os.path.splitext(os.path.basename(pdf_path))[0])):
                    ...
                    if os.path.isdir(out_path) and len(pdf_and_fig_lists) <= pagenum/2 :
                        if page_length > page_width:
                            ...
                            if not os.path.exists(os.path.join(failure_path_PPT,os.path.splitext(os.path.basename(pdf_path))[0])):
                            ...
                            if len(pdf_and_fig_lists) == 1:
                                ...
                                if not os.path.exists(os.path.join(failure_path_nopic,os.path.splitext(os.path.basename(pdf_path))[0])):
                    ...
                    if not os.path.exists(os.path.join(failure_path_noargs,os.path.splitext(os.path.basename(pdf_path))[0])):
