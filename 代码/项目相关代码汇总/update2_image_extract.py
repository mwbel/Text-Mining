...
if __name__ == "__main__":
    file_path = "D:/Project/project/Process/201808/海通证券"
    # file_path="D:/test"
    out_path = "D:/pic/海通证券/"
        ...
        try:
            ...
            for i in range(pagenum):
                ...
                if not '.......' in text:
                    ...
                    # 匹配 图表rect和来源rect
                    name_figrect_sourcerects, rest_name_figrect = match_fig_source(fig_rects, sourcerect, page_length,
                                                                                   page_width)
                    # 分别处理跨页图表和非跨页图表
